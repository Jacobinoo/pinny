    ...
    return (
      <>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Link href="/settings" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '40px', height: '40px', borderRadius: '50%', backgroundColor: 'var(--surface)', color: 'var(--text-primary)', textDecoration: 'none', marginLeft: '16px' }} title="Settings">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
